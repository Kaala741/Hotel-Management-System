        ...
        <div className="home">
            ...
            <section>
                <header className="header-banner">
                    <img src="./assets/images/hotel.webp" alt="Saul Goodman Hotel" className="header-image" />
                    <div className="overlay"></div>
                    <div className="animated-texts overlay-content">
                        <h1>
                            Welcome to <span className="phegon-color">Check In with Saul</span>
                        </h1><br />
                        <h3>Your comfort is our top priority… right after profit !.</h3>
                    </div>
                </header>
            </section>
            ...
            <h2 className="home-services">Services at <span className="phegon-color">Check In with Saul</span></h2>
